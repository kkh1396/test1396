...
/*
     * 제약조건 추가/삭제 (=> 수정: 삭제->추가)
     ...
     - 제약조건 추가 
         ...
         * UNIQUE              : ADD UNIQUE(컬럼명)     --> 중복을 허용하지 않음;
         * CHECK               : ADD CHECK(컬럼에대한 조건식) --> 특정 값들만 저장하고자 할 떄 사용 : NULL값 저장가능!
         * NOT NULL            : MODIFY 컬럼명 NOT NULL|NULL ;--> NULL값을 허용할지, 말지에 대한 제약 조건!
...
-- 2) 제약조건명 변경 : RENAME CONSTRAINT 기본제약조건명 TO 변경할제약조건명
-- DEPT_TABLE 테이블의 DEPT_ID의 제약조건명 DT_DEPTID_NN으로 변경
ALTER TABLE DEPT_TABLE RENAME CONSTRAINT SYS_C008641 TO DT_DEPTID_NN;

INSERT INTO DEPT_END VALUES ( 'D11' , '테스팀', 'L9', NULL, NULL);


DELETE   FROM DEPT_END  WHERE DEPT_ID ='D11';

-- 3) 테이블명 변경 : RENAME TO 변경할 테이블명
